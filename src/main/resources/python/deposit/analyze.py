...
condition_keywords = {
    "newCustomer": ["신규고객", "처음", "첫거래", "최초"],
    "salaryTransfer": ["급여이체", "연금이체"],
    "cardUsage": ["카드", "신용카드", "체크카드", "결제실적"],
    "internetMobileBanking": ["인터넷뱅킹", "모바일뱅킹", "비대면", "폰뱅킹"],
    "marketingConsent": ["마케팅", "정보수신", "수신동의"],
    "housingSubscription": ["청약", "주택청약"],
    "couponUsed": ["쿠폰"]
}
